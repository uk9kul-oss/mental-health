...
def stress_card_png(score: int | None, label: str, theme: dict[str, str]) -> bytes:
    ...
    muted_color = theme.get("muted_text", "#6b7280")
    ...
    fig.text(0.07, 0.75, title, color=text_color, fontsize=12, weight="bold")
    fig.text(0.07, 0.5, f"Latest score: {score_text}", color=text_color, fontsize=11)
    fig.text(0.07, 0.3, f"Status: {label}", color=text_color, fontsize=11)
    fig.text(0.07, 0.1, "Generated by Mental Health Prevalence", color=muted_color, fontsize=8)
